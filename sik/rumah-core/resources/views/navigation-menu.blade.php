        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @role('admin inovasi')
                        @php
                            $menus = [['name' => 'Beranda Admin', 'routeName' => 'admin.home'], ['name' => 'Inovasi', 'routeName' => 'admin.innovation']];
                        @endphp
                    @endrole

                    @hasrole('admin biro kabupaten|admin bagian kabupaten')
                        @php
                            $menus = [['name' => 'Beranda Admin', 'routeName' => 'admin.home'], ['name' => 'Inovasi', 'routeName' => 'admin.innovation'], ['name' => 'Pengguna', 'routeName' => 'admin.user']];
                        @endphp
                    @endrole

                    @role('admin biro provinsi')
                        @php
                            $menus = [['name' => 'Beranda Admin', 'routeName' => 'admin.home'], ['name' => 'Inovasi', 'routeName' => 'admin.innovation'], ['name' => 'Pengguna', 'routeName' => 'admin.user'], ['name' => 'Klinik Inovasi', 'routeName' => 'admin.klinik-inovasi']];
                        @endphp
                    @endrole
                    ...
                    @foreach ($menus as $menu)
                        <x-jet-nav-link href="{{ route($menu['routeName']) }}"
                            :active="request()->routeIs($menu['routeName'])">
                            {{ __($menu['name']) }}
                        </x-jet-nav-link>
                    @endforeach

                    @role('admin biro provinsi|super admin')
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('my-profile') }}">
                                {{ __('Profile') }}
                            </x-jet-dropdown-link>
